class Welcome {
  static showDialog() {
    ...
    [
      ...
      'During this alpha I\'m mainly focusing on getting a great desktop experience and the editor so... The VR support is just for PC-VR and it doesn\'t have the editing tools yet. I plan to optimize it for devices like the Oculus Quest and to implement the VR UI during the next updates, though.',
