class Welcome {
  static showDialog() {
    ...
    [
      'Welcome, my dudes!',
      'This is an alpha test of an updated webxr port of realmsvr. Which was an old webvr project of mine that prolly some of you remember from the supermedium era and the OG vive.',
      ...
      'During this alpha I\'m mainly focusing on getting a great desktop experience and the editor so... The VR support is just for PC-VR for now. I will optimize it for devices like the Oculus Quest on the next updates, though.',
